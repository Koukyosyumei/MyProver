...
from .type import TypeBOOL, TypeINT, resolve_expr_type, resolve_stmt_type, check_and_update_sigma
...
class MyProver:
    ...
    def verify_func(self, func, precond_str, postcond_str):
        ...
        check_and_update_sigma(precond_expr, actual, TypeBOOL, self.fname2var_types[func.__name__])
        actual, _ = resolve_expr_type(self.fname2var_types[func.__name__], postcond_expr)
        check_and_update_sigma(postcond_expr, actual, TypeBOOL, self.fname2var_types[func.__name__])
